...
public class SelectAudioController1 extends SceneChanger implements Initializable{
	...
	ObservableList<AudioTable> _availablelist = FXCollections.observableArrayList();
	ObservableList<AudioTable> _selectedlist = FXCollections.observableArrayList();

	AudioTable _selectedAvailableAudio;
	AudioTable _selectedSelectedAudio;
...
//		createCombinedAudio(searchTerm);
	...
	public List<String> getAudioNames () {
		...
		String createNameTextCommand = "ls -1a ./creations/*.wav | sed -r \"s/.+\\/(.+)\\..+/\\1/\"";
	...
	public void createCombinedAudio (String searchTerm) {
		...
		combineAudioCommand = combineAudioCommand + "./creations/" + searchTerm + "Audio.wav";
